...
export const runningWatches: GuideContent = {
  ...
  seoDescription: "Quale orologio da corsa scegliere nel 2026? Confronto pratico di GPS multi-band, cardio, batteria e potenza per capire in 5 minuti quale modello serve davvero al tuo tipo di corsa.",
