    ...
    return (
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[11px] text-muted-foreground truncate">Trasforma ogni corsa in premi</p>
        </div>
        <span className="text-[10px] font-bold uppercase tracking-wider text-teal-400">Prova gratis</span>
      </a>
    );
  }
          ...
          <div className="flex flex-col items-center gap-6 text-center sm:flex-row sm:text-left">
            ...
            <div className="flex-1">
              <div className="mb-2 flex items-center justify-center gap-2 sm:justify-start">
                <span className="rounded-full bg-teal-500/10 border border-teal-500/20 px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-teal-400">Partner Ufficiale</span>
              </div>
              <h3 className="font-display text-2xl font-bold text-white sm:text-3xl tracking-tight">
                ZoneRun — <span className="text-teal-400">Dai un nuovo valore alle tue corse</span>
              </h3>
              <p className="mt-2 text-sm text-teal-100/60 sm:text-base max-w-xl">
                L'esperienza move-to-earn leader del settore. Trasforma i tuoi chilometri quotidiani in premi reali, sblocca sfide cyber e domina la classifica digitale.
              </p>
            </div>
            ...
            >
              Unisciti gratis <ArrowRight className="h-4 w-4" />
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
          ...
          <div className="flex-1 text-center sm:text-left">
            <div className="mb-2 flex items-center justify-center sm:justify-start gap-3">
              ...
              <span className="rounded-full bg-teal-500/10 border border-teal-500/20 px-2.5 py-0.5 text-[9px] font-bold uppercase tracking-widest text-teal-400">Sponsorizzato</span>
            </div>
            <p className="font-display text-sm font-bold text-teal-100/90 leading-snug">Trasforma ogni chilometro in premi digitali</p>
            <p className="mt-2 text-sm leading-relaxed text-teal-100/50">
              L'app di movimento gamificata dove ogni corsa ti fa guadagnare di più. Completa le sfide, unisciti alla community globale e migliora le tue prestazioni.
            </p>
